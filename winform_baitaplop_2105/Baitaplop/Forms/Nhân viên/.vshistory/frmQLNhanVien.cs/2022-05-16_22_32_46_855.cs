...
namespace Baitaplop.Forms
{
    public partial class frmQLNhanVien : Form
    {
        ...
        private bool KiemTraDeTrongDuLieu()
        {
            ...
            if (isNotCheckGender) turnErrorLabel(6);
            ...
            return isEmpty || isNotCheckGender;
        }
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn nhập thiếu dữ liệu!", "Cảnh báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
            }
            else
            {
                if (themmoi == true)
