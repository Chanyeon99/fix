        ...
        private void btnThongKe_Click(object sender, EventArgs e)
        {
            ...
            if (!choose.Equals(""))
            {
                ...
                if (row > 0)
                {
                    ...
                    dgvThongKe.AllowUserToAddRows = true;
                    dgvThongKe.Rows.Add();
                    dgvThongKe.Rows[row + 1].Cells[3].Value = "Tổng doanh thu dự kiến:";
                    dgvThongKe.Rows[row + 1].Cells[4].Value = dgvThongKe.Rows.Cast<DataGridViewRow>()
